...
export default function UserProfileDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="flex h-6 w-6 items-center justify-center rounded-full bg-slate-900 text-[11px] font-semibold text-white">PS</span>
      ...
      {open ? (
        <div className="absolute right-0 z-30 mt-3 w-56 rounded-2xl border border-slate-200 bg-white p-3 shadow-xl shadow-slate-200/70">
          <div className="mb-3 rounded-xl bg-slate-50 px-3 py-3 text-sm text-slate-500">Dashboard actions</div>
